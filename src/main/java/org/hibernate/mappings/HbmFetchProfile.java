 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{}fetch" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class HbmFetchProfile implements IHbmNode {
    @Override
    public void accept(HbmNodeVisitor visitor) {
        visitor.visit(this);
    }

    protected List<HbmFetch> fetch;
     ...
     * {@link HbmFetch }
     */
    public List<HbmFetch> getFetch() {
        if (fetch == null) {
            fetch = new ArrayList<HbmFetch>();
        }
        return this.fetch;
    }
