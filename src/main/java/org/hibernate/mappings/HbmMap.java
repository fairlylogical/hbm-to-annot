 ...
 *         &lt;choice&gt;
 *           &lt;element ref="{}map-key"/&gt;
 *           &lt;element ref="{}composite-map-key"/&gt;
 *           &lt;element ref="{}map-key-many-to-many"/&gt;
 *           &lt;element ref="{}index"/&gt;
 *           &lt;element ref="{}composite-index"/&gt;
 *           &lt;element ref="{}index-many-to-many"/&gt;
 *           &lt;element ref="{}index-many-to-any"/&gt;
 *         &lt;/choice&gt;
 *         &lt;choice&gt;
 *           &lt;element ref="{}element"/&gt;
 ...
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
 *       &lt;attribute name="sort" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" default="unsorted" /&gt;
...
public class HbmMap implements IHbmNode {
    @Override
    ...
    protected HbmMapKey mapKey;
    @XmlElement(name = "composite-map-key")
    protected HbmCompositeMapKey compositeMapKey;
    @XmlElement(name = "map-key-many-to-many")
    protected HbmMapKeyManyToMany mapKeyManyToMany;
    protected HbmIndex index;
    @XmlElement(name = "composite-index")
    protected HbmCompositeIndex compositeIndex;
    @XmlElement(name = "index-many-to-many")
    protected HbmIndexManyToMany indexManyToMany;
    @XmlElement(name = "index-many-to-any")
    protected HbmIndexManyToAny indexManyToAny;
    protected HbmElement element;
    @XmlElement(name = "one-to-many")
    protected HbmOneToMany oneToMany;
    ...
    /**
     * Obtient la valeur de la propriété mapKey.
     *
     * @return possible object is
     * {@link HbmMapKey }
     */
    public HbmMapKey getMapKey() {
        return mapKey;
    }

    /**
     * Définit la valeur de la propriété mapKey.
     *
     * @param value allowed object is
     *              {@link HbmMapKey }
     */
    public void setMapKey(HbmMapKey value) {
        this.mapKey = value;
    }

    /**
     * Obtient la valeur de la propriété compositeMapKey.
     *
     * @return possible object is
     * {@link HbmCompositeMapKey }
     */
    public HbmCompositeMapKey getCompositeMapKey() {
        return compositeMapKey;
    }

    /**
     * Définit la valeur de la propriété compositeMapKey.
     *
     * @param value allowed object is
     *              {@link HbmCompositeMapKey }
     */
    public void setCompositeMapKey(HbmCompositeMapKey value) {
        this.compositeMapKey = value;
    }

    /**
     * Obtient la valeur de la propriété mapKeyManyToMany.
     *
     * @return possible object is
     * {@link HbmMapKeyManyToMany }
     */
    public HbmMapKeyManyToMany getMapKeyManyToMany() {
        return mapKeyManyToMany;
    }

    /**
     * Définit la valeur de la propriété mapKeyManyToMany.
     *
     * @param value allowed object is
     *              {@link HbmMapKeyManyToMany }
     */
    public void setMapKeyManyToMany(HbmMapKeyManyToMany value) {
    ...
    /**
     * Obtient la valeur de la propriété compositeIndex.
     *
     * @return possible object is
     * {@link HbmCompositeIndex }
     */
    public HbmCompositeIndex getCompositeIndex() {
        return compositeIndex;
    }

    /**
     * Définit la valeur de la propriété compositeIndex.
     *
     * @param value allowed object is
     *              {@link HbmCompositeIndex }
     */
    public void setCompositeIndex(HbmCompositeIndex value) {
        this.compositeIndex = value;
    }

    /**
     * Obtient la valeur de la propriété indexManyToMany.
     *
     * @return possible object is
     * {@link HbmIndexManyToMany }
     */
    public HbmIndexManyToMany getIndexManyToMany() {
        return indexManyToMany;
    }

    /**
     * Définit la valeur de la propriété indexManyToMany.
     *
     * @param value allowed object is
     *              {@link HbmIndexManyToMany }
     */
    public void setIndexManyToMany(HbmIndexManyToMany value) {
        this.indexManyToMany = value;
    }

    /**
     * Obtient la valeur de la propriété indexManyToAny.
     *
     * @return possible object is
     * {@link HbmIndexManyToAny }
     */
    public HbmIndexManyToAny getIndexManyToAny() {
        return indexManyToAny;
    }

    /**
     * Définit la valeur de la propriété indexManyToAny.
     *
     * @param value allowed object is
     *              {@link HbmIndexManyToAny }
     */
    public void setIndexManyToAny(HbmIndexManyToAny value) {
    ...
    /**
     * Obtient la valeur de la propriété oneToMany.
     *
     * @return possible object is
     * {@link HbmOneToMany }
     */
    ...
    /**
     * Définit la valeur de la propriété oneToMany.
     *
     * @param value allowed object is
     *              {@link HbmOneToMany }
     */
    public void setOneToMany(HbmOneToMany value) {
